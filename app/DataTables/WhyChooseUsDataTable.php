    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='". route('admin.why-choose-us.destroy', $query->id)."' class='delete-item btn btn-danger'><i class='fas fa-minus-circle'></i></a>";

                return $edit." ".$delete;
            })
            ->addColumn('icon', function($query){
                return '<i class="'.$query->icon.' btn btn-secondary btn-sm text-primary"></i>';
            })
